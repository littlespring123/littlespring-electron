...
function bird_fly() {
	...
	bird.value.setAttribute("style", `top:${bird.value.offsetTop + speed.value}px`)
}
...
const start = () => {
	...
	setTimeout(() => {
		...
		let test_time = (container.offsetWidth - bird.value.offsetLeft - bird.value.offsetWidth - pipe[0].offsetWidth) / pipe_speed
...
function test_distance() {
	...
	console.log(b_top + "," + height_up + "," + bird_height.value + "," + height_down)
